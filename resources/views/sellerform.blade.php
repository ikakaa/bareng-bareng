        ...
        <div class="tempat-form mx-4">
            <div class="form-card  shadow justify-start  flex-nowrap px-4 py-3 rounded w-2/3 " style="background:#F4F9E9">
                ...
                <form action="/do_uploadrequestseller" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" maxlength="150" name="address" required class="shadow  appearance-none border border-red rounded  py-2 sm:py-3 px-3 text-grey-darker mb-1 custwidth  block focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10" placeholder="Sibolga, jalan u no 4a">
                    ...
                    <label for="identitynumber" class="block sm:mb-2 mb-1 w-full  mt-2">Identity Number [KTP / SIM / Paspor] [Won't
                        be shared]</label>
