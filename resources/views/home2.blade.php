...
@section('content')
    ...
    <body>
        ...
        <div class="parent mt-8">
            <div class="div1 card1"> 
        
                <img src="src/img.jpg">
                <p class="highlight-desc">Limited in stock units available at 10am, 14th of March 2022 (GMT+8)</p>
            </div>

            <div class="div2 card2 mb-3"> 
                <img src="src/item.png" class="ml-12">
                <p class="highlight-desc">Limited in stock units available at 10am, 14th of March 2022 (GMT+8)</p>

            </div>
            
            <div class="div3 card2">
                <img src="src/item.png" class="ml-12">
                <p class="highlight-desc">Limited in stock units available at 10am, 14th of March 2022 (GMT+8)</p>
...
<div class="tempat-highlight flex flex-nowrap justify-center px-64 pt-10">
